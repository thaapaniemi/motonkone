...
Virtualboxin perusversio (v. 2010 lähtien) on ilmainen koti- ja arviointikäyttöön, Oracle myy Enterprise-versiota n. 50 USD hintaan. 

Virtualboxin perusratkaisut ovat avointa lähdekoodia (GPLv2 -lisenssillä). 

Virtualboxin kehitys aloitettiin v. xxxxx yrityksen yyyy toimesta. Sitten Sun osti. Sitten Oracle osti.
