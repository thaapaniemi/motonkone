...
%%%%%%%%%%%%%%%%%%%%%%
% \chapter{Testiohjelma}
% \label{ch:Testiohjelma}
%
% Testiohjelman avulla pystyy tallentamaan ja toistamaan sarjaliikennettä.
% * Eri porttinopeuksien tallennus
% * viiveiden tallennus (aka toistettavuus alkuperäisen datan tapaan)
% * formaatin määritys ja ohjelman perusrakenne
%%%%%%%%%%%%%%%%%%%%
